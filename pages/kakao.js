  ...
  (window.kakao = window.kakao || {}),
    ...
    (function () {
      ...
      var c = o.onloadcallbacks,
        E = ['v3'],
        S = '',
        I = { v3: r + '//t1.daumcdn.net/mapjsapi/js/main/4.4.3/kakao.js', services: r + '//t1.daumcdn.net/mapjsapi/js/libs/services/1.0.2/services.js', drawing: r + '//t1.daumcdn.net/mapjsapi/js/libs/drawing/1.2.6/drawing.js', clusterer: r + '//t1.daumcdn.net/mapjsapi/js/libs/clusterer/1.0.9/clusterer.js' },
        _ = (function (a) {
          var t = {};
          return (
      ...
      (S = _.appkey), S && (o.apikey = S), (o.version = '4.4.3');
      var R = _.libraries;
